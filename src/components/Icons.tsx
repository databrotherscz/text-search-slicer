...
function CrossIcon(props: IIconProps) {
    return (
        <svg style={{ width: "1.8em", height: "auto", display: "block" }} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" x="0px" y="0px">
...
function SearchIcon(props: IIconProps) {
    return (
        <svg style={{ width: "1.8em", height: "auto", display: "block", margin: "auto" }} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" x="0px" y="0px">
